# Step 1: Filter Tornadoes that occured in Oklahoma for each year
# Put each filtered data frame for each year in the list df_collect
import pandas as pd
import os

raw_path = 'Data/events/raw'
interim_out_path = 'Data/events/interim/Oklahoma_Tornadoes_2000_2021.csv'
processed_out_path = 'Data/events/processed/final_Oklahoma_Tornadoes_2000_2021.csv'
df_collect = []
...
# is in day-month-year format. We split this informations into BEGIN_DATE, BEGIN_TIME,
# END_DATE, END_TIME.
...
# occurence of a tornado based on how far from each station 
